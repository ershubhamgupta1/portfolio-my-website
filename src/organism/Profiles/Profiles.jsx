    ...
    return (
        ...
        <div className="single-profile">
            <div className="profile-txt">
                <a href={link ? link : '/'}><i className={iconName}></i></a>
			...
			<div className="profiles-details">
				...
				<div className="container">
					<div className="profiles-content">
						<div className="row">
                            <ProfileCard name="linkedin" iconName="fa-linkedin-square"/>
                            ...
                            <ProfileCard name={'github'} link='https://github.com/ershubhamgupta1/portfolio-my-website' iconName='flaticon-github-logo' />
						</div>
